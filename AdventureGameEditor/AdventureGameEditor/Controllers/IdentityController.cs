...
namespace AdventureGameEditor.Controllers
{
    public class IdentityController : Controller
    {
        ...
        public IdentityController(AdventureGameEditorContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Register([Bind("Name, NickName, Email, ValidateEmail, Password, ValidatePassword")] RegisterViewModel userData)
        {
