...
namespace AdventureGameEditor.Migrations
{
    ...
    [Migration("20200219150002_OwnerAddedToGameModel")]
    partial class OwnerAddedToGameModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdventureGameEditor.Models.Field", b =>
                {
                    ...
                    b.Property<int?>("FieldCoordinateID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdventureGameEditor.Models.FieldCoordinate", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("HorizontalCoordinate")
                        .HasColumnType("int");

                    b.Property<int>("VerticalCoordinate")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.ToTable("FieldCoordinate");
                });
            ...
            modelBuilder.Entity("AdventureGameEditor.Models.Field", b =>
                {
                    ...
                    b.HasOne("AdventureGameEditor.Models.FieldCoordinate", "FieldCoordinate")
                        .WithMany()
                        .HasForeignKey("FieldCoordinateID");
